    ...
    def main_loop(self, laberinto, posicion_inicial, posicion_final = None) -> None:
        ...
        while (px, py) != posicion_final:
            ...
            if tecla == key.UP and px > 0 and self.mapa[px - 1][py] != '#':
                ...
                py += 1  # Flecha derecha
        print ("felicidades eres lo maximo has logrado completar todo el proceso")
...
class JuegoArchivo():
    ...
    def leer_archivo(self) -> str:
        path = "/Users/taily catrrillo/OneDrive/Escritorio/proyecto de juego de laberinto/proyecto-de-juegos/mapas"
        laberinto = """..###################
        ....#...............#
        #.#.#####.#########.#
        #.#...........#.#.#.#
        ...
        if os.path.exists(path):
            ...
            if len(mapas) > 0:
                ...
                raise NotFileError("No hay mapas en la carpeta, cargaremos nuestro mapa por defecto")
